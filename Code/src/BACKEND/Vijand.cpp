...
Vijand::Vijand(const char* aNaam, const char* aBeschrijving, int aMinimumobjecten, int aMaximumobjecten, int aLevenspunten, int aAanvalskans, int aAanvalsschadeMin, int aAanvalsschadeMax)
    : mNaam(nullptr), mBeschrijving(nullptr), mMinimumObjecten(aMinimumobjecten), mMaximumObjecten(aMaximumobjecten), mLevenspunten(aLevenspunten), mAanvalskans(aAanvalskans), mAanvalsschadeMin(aAanvalsschadeMin), mAanvalsschadeMax(aAanvalsschadeMax) {
...
bool Vijand::isVerslagen() const {
    return mLevenspunten <= 0;
}
...
int Vijand::getAantalSpelobjecten() const {
    return mSpelobjecten.size();
}

int Vijand::getLevenspunten() const {
    return mLevenspunten;
}

const char* Vijand::getNaam() const {
    return mNaam;
}

const char* Vijand::getBeschrijving() const {
    return mBeschrijving;
}

int Vijand::getMinimumObjecten() const {
    return mMinimumObjecten;
}

int Vijand::getMaximumObjecten() const {
    return mMaximumObjecten;
}
