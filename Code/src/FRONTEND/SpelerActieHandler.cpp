...
SpelerActieHandler::SpelerActieHandler(std::unique_ptr<Spelwereld>& aSpelwereld, std::unique_ptr<Speler>& aSpeler, std::unique_ptr<GebruikersInterface>& aGebruikersInterface)
...
SpelerActieHandler::Actie SpelerActieHandler::stringNaarActie(const std::string& aActie) {
    if (aActie == "Kijk") return Actie::Kijk;
    if (aActie == "Zoek") return Actie::Zoek;
    if (aActie == "Ga naar") return Actie::GaNaar;
    if (aActie == "Pak") return Actie::Pak;
    if (aActie == "Leg neer") return Actie::LegNeer;
    if (aActie == "Bekijk object") return Actie::BekijkObject;
    if (aActie == "Bekijk vijand") return Actie::BekijkVijand;
    if (aActie == "Bekijk zelf") return Actie::BekijkZelf;
    if (aActie == "Sla") return Actie::Sla;
    if (aActie == "Draag wapenrusting") return Actie::DraagWapenrusting;
    if (aActie == "Draag wapen") return Actie::DraagWapen;
    if (aActie == "Wacht") return Actie::Wacht;
    if (aActie == "Consumeer") return Actie::Consumeer;
